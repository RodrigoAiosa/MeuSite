...
for i in range(0, len(pbi_projects), 3):
    ...
    for j in range(3):
        ...
        if idx < len(pbi_projects):
            ...
            # Texto para WhatsApp (com descrição + link)
            wa_text = f"🚀 *{p['title']}*\n\n💡 {p['desc']}\n\n🔗 Confira: {p['url']}"
            wa_link = f"https://api.whatsapp.com/send?text={urllib.parse.quote(wa_text)}"
            
            # LinkedIn: SOMENTE A URL (sem título, sem descrição)
                ...
                <div class="flip-card">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            ...
                            <div style="font-size: 0.8rem; color: #9ca3af; margin-top: 12px;">Compartilhar:</div>
